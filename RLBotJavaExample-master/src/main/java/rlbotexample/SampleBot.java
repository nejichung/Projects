...
public class SampleBot implements Bot {
    ...
    /**
     * This is where we keep the actual bot logic. This function shows how to
     * chase the ball. Modify it to make your bot smarter!
     */
...
//        if(input.car.boost == 0.0){
//            myCar.position = 
////           ArrayList<BoostPad> fullBoost = BoostManager.getFullBoosts();
////            myCar.position.x = 1;
////            myCar.position.y = 1;
////            myCar.getClosestBoost();
//        }
        // next i want to make the bot pick up boost if not full boost
        // This is optional!
...
//    private getClosestBoost()
    ...
    /**
     * This is the most important function. It will automatically get called by
     * the framework with fresh data every frame. Respond with appropriate
     * controls!
     */
    @Override
